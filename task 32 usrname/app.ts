...
// list Loop through the new_users list to see if each new username has
//  already been used. If it has, print 
...
let current_users : string[] = ['admin','eric','ali','hamza']
let new_users : string[] = ['admin','fatima','ali','haseeb','noor']
